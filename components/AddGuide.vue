<template>
  <div>
    ...
    <div class="container py-6 mx-auto dark:text-slate-200">
      ...
      <form
        @submit.prevent="addGuide"
        class="p-4 bg-white rounded-lg shadow-2xl dark:text-slate-200 dark:bg-slate-900"
      >
        <div class="px-6 mb-6 md:flex md:justify-between md:items-center">
          <div>
            <label
              class="block pr-4 mb-1 font-bold text-gray-500 md:text-right md:mb-0 dark:text-slate-200 dark:bg-slate-900"
              for="parentCategory"
            >
              Catégorie parente :
            </label>
          ...
          <div class="w-full md:w-3/4">
            <div class="relative">
              ...
              <div
                class="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 pointer-events-none dark:text-slate-200 dark:bg-slate-900"
              >
                <svg
        ...
        <div
          class="px-6 mb-6 md:flex md:justify-between md:items-center dark:text-slate-200 dark:bg-slate-900"
        >
          <div>
            <label
              class="block pr-4 mb-1 font-bold text-gray-500 md:text-right md:mb-0 dark:text-slate-200 dark:bg-slate-900"
        ...
        <div class="px-6 mb-6">
          <label
            class="block mb-2 font-bold text-gray-500 dark:text-slate-200 dark:bg-slate-900"
            for="image"
          >
            Image :
          </label>
          <div class="flex flex-col items-center space-y-4">
            ...
            >
              <div class="text-center">
                <svg
                  class="w-12 h-12 mx-auto text-gray-400 transition-colors duration-300 ease-in-out group-hover:text-gray-600 dark:text-slate-200 dark:bg-slate-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p
                  class="text-sm text-gray-500 transition-colors duration-300 ease-in-out group-hover:text-gray-600 dark:text-slate-200 dark:bg-slate-900"
                >
                  <span>Ajouter une image</span>
                </p>
                <p
                  class="text-xs text-gray-500 transition-colors duration-300 ease-in-out group-hover:text-gray-600 dark:text-slate-200 dark:bg-slate-900"
                >
                  PNG, JPG, JPEG
                </p>
              </div>
              ...
              <div
                x-show="imagePreview"
                class="absolute inset-0 w-full h-full bg-center bg-no-repeat bg-contain"
            ...
            <button
              ...
              type="button"
              @click="removeImage"
              class="inline-block px-2 py-1 font-bold text-gray-500 transition duration-150 ease-in-out border border-transparent rounded-md hover:text-white hover:bg-red-500 hover:border-gray-300 focus:outline-none focus:border-gray-300 focus:shadow-outline-gray active:bg-gray-100"
            >
              Supprimer l'image
            </button>
          </div>
        </div>
        <div class="px-6 mb-6 dark:text-slate-200 dark:bg-slate-900">
          <label
            class="block mb-2 font-bold text-gray-500 dark:text-slate-200 dark:bg-slate-900"
            for="title"
          >
        ...
        <div
          class="flex items-center justify-center px-6 py-4 bg-gray-100 rounded-b-lg dark:text-slate-200 dark:bg-slate-900"
        >
          <button
            type="submit"
