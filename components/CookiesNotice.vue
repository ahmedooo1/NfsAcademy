...
<template>
  <div v-if="!cookies.accepted && !cookies.rejected" class="fixed bottom-0 left-0 z-40" ref="fixedEl">
      ...
      <div class="flex flex-col sm:flex-row sm:space-x-2 sm:justify-end">
        ...
        <button class="w-full px-4 py-2 mt-2 text-white bg-red-500 rounded-md btn btn-gray-400 sm:mt-0 sm:w-auto hover:bg-red-700" @click="rejectCookies">
          Refuser
        </button>
