<template>
  <div class="p-4 mx-auto my-4 font-sans bg-white rounded-lg shadow-md md:w-1/2">
    <header class="py-4 bg-white">
      <div class="container px-4 mx-auto text-center">
        ...
        <p class="text-lg text-gray-600">
          Ce graphique montre la répartition des utilisateurs et des guides, ainsi que la répartition des utilisateurs par rôle.
        </p>
      </div>
    </header>
    <div class="w-full">
    ...
    <div class="p-4 mt-4 bg-gray-100 rounded-lg">
      <ul class="text-lg text-gray-600 list-disc list-inside">
...
export default {
  data() {
    return {
      chartOptions: {
        ...
        labels: [ "Tous les utilisateurs", "Guides", "Rôle Admin", "Rôle Rédacteur", "Rôle Utilisateur"],
        legend: {
          position: "bottom",
        },
      },
  ...
  async mounted() {
    try {
      ...
      this.chartData = [ userCount, guideCount, roleAdminCount, roleRedacteurCount, roleUserCount];
    } catch (error) {
