<template>
  <div
    class="flex flex-col items-center justify-center bg-gray-100 dark:text-slate-200 dark:bg-slate-900"
  >
    <client-only>
      <editor-content
        :editor="editor"
        v-model="value"
        class="dark:text-slate-200 dark:bg-slate-900 w-full px-4 py-2 overflow-y-auto bg-gray-100 border border-gray-300 rounded-md editor-content max-h-96 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
        @input="onInput"
      />
    </client-only>
  </div>
