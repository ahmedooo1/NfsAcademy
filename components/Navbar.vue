  ...
  <nav class="sticky w-full bg-blue-700">
    <div class="container px-6 py-6 mx-auto md:flex md:justify-between md:items-center">
      <div class="flex items-center justify-between w-full">
        ...
        <button @click="toggleMenu" class="absolute text-white right-6 md:hidden">
        ...
        <div
          ...
          class="flex items-center justify-between md:flex md:ml-6"
        >
          <NuxtLink
            to="/guidesList"
            class="flex px-4 py-2 mx-8 text-white rounded-full hover:bg-white hover:text-gray-800"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <NuxtLink
            to="/profil"
            v-if="isLoggedIn"
            class="flex items-center px-4 py-2 mx-8 text-white rounded-full hover:bg-white hover:text-gray-800"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
